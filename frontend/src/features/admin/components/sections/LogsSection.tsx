                            ...
                            <div style={{ marginBottom: '1rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '1rem', flexWrap: 'wrap' }}>
                              ...
                              <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
                                ...
                                {log.details?.product_id && (
                                  <Link to="/" search={{ product: log.details.product_id }} className="btn btn-secondary btn-sm" style={{ fontSize: '0.65rem', height: '20px', padding: '0 0.5rem', display: 'flex', alignItems: 'center' }}>
                                    Product
                                  </Link>
                                )}
